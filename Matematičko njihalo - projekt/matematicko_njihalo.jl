...
md"Konačni oblik jednadžbe koju ćemo riješiti koristeći SecondOrderODEProblem:"

# ╔═╡ d860dfa7-06d6-44c9-b251-20871c3fa53f
md"$\ddot{\theta} = -\frac{\lambda}{m}\dot{\theta} - \frac{g}{l}\sin{\theta}$"
...
begin
	sliderm = @bind m Slider(0.25:0.25:5.0, default=3, show_value=true)
...
plot(sol, idxs = [2, 1], linewidth = 2, title = "Matematičko njihalo", xlabel = "Vrijeme [s]", label = ["Kut [rad]" "Kutna brzina [rad/s]"])
...
begin
	sliderm1 = @bind m1 Slider(0.25:0.25:5.0, default=3, show_value=true)
	...
	slidertime = @bind time Slider(0.0:0.25:50, default=0.0, show_value=true)
...
theta = sol1(time)[2] #spremanje kuta iz rjesenja jednadzbe

# ╔═╡ 67fb28d3-498f-4683-9be9-207b563f3202
function pozicija_njihala(theta, l1)
	pozicija_x = l1 * sin(theta)  #racunanje pozicije x
	pozicija_y = -l1 * cos(theta) #racunanje pozicije y
	return pozicija_x, pozicija_y
end

# ╔═╡ b6952933-53bf-4b54-931c-4ab52fc17563
x, y = pozicija_njihala(theta, l1)
...
begin
	...
	#prilagodba ravnine
	plot!(size = (500, 500), xlims = (-5, 5), ylims = (-6, 0))
end
